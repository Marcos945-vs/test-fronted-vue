...
import {upcommingCards} from './card';
</script>
<template>
    <v-card elevation="10" >
            ...
            <div class="mt-sm-10 mt-5">
                <div class="d-flex align-center mt-6" v-for="list in upcommingCards" :key="list.title">
                    ...
                    <div class="pl-4 mt-n1">
                        ...
                        <h6 class="text-subtitle-1 text-medium-emphasis" v-text="list.rank"></h6>
                    </div>
                    <div class="ml-auto font-weight-medium text-subtitle-1 text-medium-emphasis" v-text="list.subtitle"></div>
                </div>
            </div>
        </v-card-item>
    </v-card>
